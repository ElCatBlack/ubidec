        ...
        <section class="info-general">
            <div class="info-colum1">
                ...
                <div class="direction">
                    ...
                    <div class="coordinate"><span>Coordenadas:</span><input type="text" name="coordenadas" placeholder="Coordenadas geograficas"></div>
                    <div class="coordinate"><span>Dirección:</span><input type="text" name="direccion"  placeholder="Direccion"></div>
                ...
                <div class="instituto-contact">
                    ...
                    <div class="contact"><span>Télefono:</span><div class="contact-regis"><img src="icons/telefono.png" alt=""><input type="text" name="telefono" placeholder="telefono"></div></div>
                    <div class="contact"><span>Correo:</span><div class="contact-regis"><img src="icons/correo.png" alt=""><input type="text" name="correo" placeholder="correo"></div></div>
                </div>
                
                <div class="instituto-redes">
                    <h2 style="font-size: 22px;margin-bottom: 5px;">Redes:</h2>
                    <div class="redes-f">
                        <div class="red-form"><img src="icons/facebookn.png" alt=""><input type="url" name="facebook" placeholder="vinculo o link (opcional)"></div>
                        <div class="red-form"><img src="icons/instagramn.png" alt=""><input type="url" name="instagram" placeholder="vinculo o link (opcional)"></div>
                        <div class="red-form"><img src="icons/whatsappn.png" alt=""><input type="url" name="whatsapp" placeholder="vinculo o link (opcional)"></div>
                        <div class="red-form"><img src="icons/twittern.png" alt=""><input type="url" name="twitter" placeholder="vinculo o link (opcional)"></div>
                        <div class="red-form"><img src="icons/youtuben.png" alt=""><input type="url" name="youtube" placeholder="vinculo o link (opcional)"></div>
                    </div>
                    <div class="pagina"><span>Sitio web:</span><input type="url" name="pagina" placeholder="sitio web (opcional)"></div>
                </div>
            </div>
        </section>
        ...
        <section class="info-principal">
            <div class="info-colum2">
                <header class="title-instituto">
                    <input type="text" name="nom_instu" id="" placeholder="Titulo del instituto">
                </header>
                ...
                <div class="featured-info">
                    ...
                    <div class="data-school">
                        ...
                        <div class="data"><span>CUE:</span><input type="number" name="cue" placeholder="CUE"></div>
                ...
                <div class="characteristics"> 
                    <div class="structure">
                        ...
                        <ul class="colum-info">
                            <li class="info-structure"><span>Director:</span><input type="text" name="director" placeholder="Nombre del director"></li>
                            <li class="info-structure"><span>Subdirector:</span><input type="text" name="subdirector" placeholder="Nombre del subdirector"></li>
                            <li class="info-structure"><span>Secretario:</span><input type="text" name="secretario" placeholder="Nombre del secretario"></li>
                        </ul>
                    </div>
