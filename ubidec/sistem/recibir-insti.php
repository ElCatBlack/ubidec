...
// $sql = "SELECT id,nom_instu,tipo,niveles,provincia,localidad,direccion,telefono FROM institutos";
// $r = $con->query($sql);

// $sql = "SELECT institutos.id, provincias.provincia AS provi, institutos.provincia, nom_instu, tipo, niveles, localidad, direccion, telefono FROM institutos
...
$output = "";
if($r->num_rows==0){
    $output .= '<div class="error-insti"><h1>NINGUN INSTITUTO CARGADO</h1></div>';
}elseif($r->num_rows>0){
