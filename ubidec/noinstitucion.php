...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($r->num_rows > 0) {
        //trae la provincia y la localidad
        $instituto = $r->fetch_assoc();
        $provin = $instituto['provi'];
        $loca = $instituto['locas'];
        // rae lo que cuenta en la institucion
        ...
        $r_modalidad = $con->query($sql_modalidad);
            ...
            echo "Error en la consulta de modalidades: " . $con->error;
        } else {
            $modalidad = [];
        ...
        if ($r_redes === false) {
         echo "Error en la consulta de redes sociales: " . $con->error;
        } else {
        $redes = [];
            ...
            <div class="info-colum2">
                ...
                <div class="featured-info">
                    ...
                    <div class="data-school">
                        ...
                        <div class="data"><span>Niveles:</span><p><?php echo $instituto['niveles']; ?></p></div>
                ...
                <div class="characteristics"> 
                    ...
                    <div class="additional">
                        ...
                        <ul class="colum-info2">
                            ...
                            <!-- <li class="info-additional"><span>Subvención:</span><p>✗</p></li> -->
                        </ul>
                    </div>
                </div>
