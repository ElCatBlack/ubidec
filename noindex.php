        ...
        <header class="menu-content">
            ...
            <div class="support">
                <div class="support-items">
                    ...
                    <a href="#">Soporte</a>
                    <a href="session.php">Soy secretario</a> 
    ...
    <main class="contenido">
        ...
        <div class="back-filtro">
            <div class="filtro-content">
                <header class="tittle">
                    <span>FILTRO</span>
                    <button class="drop-btn"><img src="icons/flecha-abajo.png" alt="Expandir filtros"></button>
                </header>
                <section class="sidebar">
                    <div class="item">
                        ...
                        <div class="subitem">
                            ...
                            <li class="item-li" data-option="Primario"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Primario</a></li>
                            <li class="item-li" data-option="Secundario"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Secundario</a></li>
                            <li class="item-li" data-option="Técnico"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Técnico</a></li>
                            <li class="item-li" data-option="Universitario"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Universitario</a></li>
                        </div>
                    </div>
                    <div class="item">
                        <a class="filter">Horarios Turnos<button class="arrow"><img src="icons/flecha-abajo.png" alt="Expandir filtros"></button></a>
                        <div class="subitem">
                            <li class="item-li" data-option="Mañana"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Mañana</a></li>
                            <li class="item-li" data-option="Tarde"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Tarde</a></li>
                            <li class="item-li" data-option="Noche"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Noche</a></li>
                            <li class="item-li" data-option="Contraturno"><div class="checkbox"><img src="icons/controlar.png" alt="Expandir filtros"></div><a class="subfilter" href="#">Contraturno</a></li>
                        </div>
                    </div>
                    <div class="item">
